...
for i=1:size(particles, 1)
    particles(i,:) = predict_pose(particles(i,:), public_vars.motion_vector, read_only_vars, public_vars);
end
...
% III. Resampling
particles = resample_particles(particles, weights, read_only_vars, public_vars);
